...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        introModels.add(new IntroModel(Config.SLIDE_ONE_ICON, Lang.intro_slide_one_title,Lang.intro_slide_one_description));
        introModels.add(new IntroModel(Config.SLIDE_TWO_ICON, Lang.intro_slide_two_title,  Lang.intro_slide_two_description));
        introModels.add(new IntroModel(Config.SLIDE_THREE_ICON, Lang.intro_slide_three_title,Lang.intro_slide_three_description));
        ...
        getStarted.setText(Lang.get_started);
